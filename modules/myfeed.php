<label><p class="sm-text noselect">MY FEED</p></label>
...
$sql2 = "SELECT * FROM feedPosts WHERE userProfile = '$friendUser' OR poster = '$friendUser' ORDER BY date_created DESC LIMIT 5";
