...
<html lang="en">
	...
	<?php include_once('modules/navbar.php'); ?>
		...
		<h4 class='pt-2 pb-1 noselect'><a class='me-1 noselect'>🔭</a>Looking for a group? We got you.</h4><?php include_once($_SERVER['DOCUMENT_ROOT'] . '/modules/gameSearch.php'); ?>
...
";
			...
			echo "<button id='" . $groupid . "' value='" . $groupid . "' onclick='joinGroup(this)' class='btn btn-success btn-sm'>Join group!</button>";
			}
			if($_SESSION['username'] == $user){
			echo "<button value='" . $groupid . "' onclick='deleteGroup(this)' title='Delete this group!' class='sm-text btn btn-sm'><i class='bi bi-x'></i></button>";
		}else{
