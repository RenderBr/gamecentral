...
<html lang="en">
    <head>
		<meta name="description" content="GameCentral flash games repository. We're trying to archive flash games and make them playable on the web! Play anything your heart desires and relive your childhood!">
		<meta name="keywords" content="gaming, lfg, discord lfg, video game, looking for group, looking for squad, gc, flash games, play flash, play games, online, play online games, html5, rust, play old flash games">
		<meta name="robots" content="index, follow">
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta name="language" content="English">
		<title><?php echo $websitename . " - flash games archive!"; ?></title>
		<meta name="title" content="GameCentral - flash games archive!">
        <!-- Favicon-->
        <!-- Bootstrap icons-->
	...
	<?php include_once('modules/navbar.php'); ?>
		...
		<label><p class="sm-text noselect mt-1">RECENTLY ARCHIVED</p></label>


<div class='container-fluid bg-dark2 px-4' style='max-width:98%;height:max-content;padding: 15px 0 15px 0px;border-radius: 10px;'>
<?php

$sql = "SELECT * FROM flashgame ORDER BY id DESC LIMIT 20 OFFSET " . $pageOffset . "";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
		...
		$gameId = $row['id'];
		$id = $gameId;
		$dateUploaded = $row['date_created'];
		$timeAgo = time_elapsed_string($dateUploaded);


		echo '<div class="col-sm-3 ">
				<div class="p-3 bg-darkest rounded"><a style="color:white;" href="/flashgame?g=' . $id . '"><img class="img-fluid img-thumbnail" style="padding:inherit !important;border: none !important;height: 13.7rem;" src="' . $image . '"><h3 style="font-size: large !important;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">' . $gameName . ' </a></h3><p style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;margin-bottom:0rem !important;" class="gray noselect">' . $desc . '</p><a title="' . $dateUploaded . '" class="sm-text noselect" style="color:#525457 !important;">posted ' . $timeAgo . ' | ' . $visits . ' visits</a></div>
			</div>';
  }
} else {
	$noResults = true;
